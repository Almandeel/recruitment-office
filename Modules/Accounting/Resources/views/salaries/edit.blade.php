@extends('layouts.master', [
    ...
    'crumbs' => [
        ...
        [route('accounting.salaries.show', $salary), 'مرتب شهر: ' . $salary->month . ' للموظف: ' . $salary->employee->name],
        ['#', 'تعديل'],
    ]
])
        ...
        @component('components.tabs')
            ...
            @slot('contents')
                @component('components.tab-content')
                    ...
                    <div class="row">
                        <div class="col">
                            <form class="form" action="{{ route('accounting.salaries.update', $salary) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <fieldset>
                                    <legend>
