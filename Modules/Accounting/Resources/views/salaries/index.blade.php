                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <h3 class="card-title float-right">
                                    <a class="btn btn-primary btn-sm" href="{{ route('accounting.salaries.create') }}"><i class="fa fa-plus"></i> إضافة</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('accounting.salaries.show', ['salary' => $salary, 'layout' => 'print']) }}"
                                            ...
                                            @endpermission
                                            @permission('salaries-read')
                                            <a href="{{ route('accounting.salaries.show', $salary) }}" class="btn btn-info">
                                                <i class="fa fa-eye"></i>
                                                <span>عرض</span>
                                            </a></li>
                                            @endpermission
